...
public abstract class BLEHandler extends Handler {
	...
	private void handleData(Object obj, int typeIndex) {
		...
		else if (typeIndex == BLEProvider.INDEX_SEND_DATA_TIMEOUT_SIXTY_SECONDS)
		{
			notifyForSendDataSixtyTimeout((byte[]) obj);
		}
		else 
		{
			// TODO
	...
	protected void notifyForSendDataSixtyTimeout(byte[] data){
		bleProviderObserver.updataFor_notifyForSendDataSixtyTimeout(data);
	}
